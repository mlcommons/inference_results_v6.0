    ...
    def create_network(self, builder: trt.Builder):
        ...
        if self.is_int8:
            ...
            if not os.path.exists(ft_weights_dir):
                ft_weights_dir = paths.MODEL_DIR / "bert/fp8/faster-transformer-bert-fp8-weights-scales"
            BERTFP8FasterTransformer(network, self.bert_config, self.seq_len, str(ft_weights_dir))
        else:
